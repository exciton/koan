...
def _queue_new_plan(ctx, project_name, idea):
    ...
    insert_pending_mission(ctx.instance_dir, f"/plan {idea}", project_label)
...
def _queue_issue_plan(ctx, owner, repo, issue_number):
    ...
    insert_pending_mission(ctx.instance_dir, f"/plan {issue_url}", project_label)
...
def _queue_tracker_issue_plan(ctx, issue_url: str):
    ...
    insert_pending_mission(ctx.instance_dir, f"/plan {issue_url}", ref.project_name)
