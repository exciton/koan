...
def _maybe_queue_autoreview(
    ...
    try:
        inserted_review = insert_pending_mission(instance_dir, f"/review {pr_url}", project_name or "")
        inserted_rebase = insert_pending_mission(instance_dir, f"/rebase {pr_url}", project_name or "")
